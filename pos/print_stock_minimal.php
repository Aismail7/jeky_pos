...
if ($_SESSION['userName'] == '' && $_SESSION['userPassword'] == '')
{
	...
	$content = "<table style='border-bottom: 1px solid #999999; padding-bottom: 10px; width: 240mm;'>
				...
				<p style='text-align: center; width: 206mm; font-size: 11pt;'><b><u>Stock Minimal</u></b> <br><span style='font-size: 10pt;'>$indoDate</span></p>
				<br>
				<table cellpadding='0' cellspacing='0' style='width: 210mm;'>
					<tr>
						...
						<th style='width: 25mm; padding: 5px 0px 5px 0px; font-size: 10pt;'>Harga Beli</th>
					</tr>";
					
					// showing the funds based on period date
					$queryProduct = "SELECT * FROM as_products WHERE productStock <= 2 ORDER BY productStock ASC";
					...
					{
						$productName = chunk_split($dtProduct['productName'], 30, "<br>");
						...
						$content .= "
							<tr valign='top'>
								...
								<td style='padding: 5px 0px 5px 0px; font-size: 10pt;'>$dtProduct[productBuyPrice]</td>
							</tr>
						";
						$i++;
					}
	...
	try
	{
		$html2pdf = new HTML2PDF('P', 'A5','fr', false, 'ISO-8859-15',array(1, 1, 1, 1)); //setting ukuran kertas dan margin pada dokumen anda
