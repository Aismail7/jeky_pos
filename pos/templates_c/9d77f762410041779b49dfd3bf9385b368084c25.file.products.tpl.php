<?php /* Smarty version Smarty-3.1.11, created on 2017-08-19 21:57:13
         compiled from ".\templates\products.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1086359797ce5de8dc2-96883103%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '1086359797ce5de8dc2-96883103',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.11',
  'unifunc' => 'content_59797ce60da031_83135865',
  'variables' => 
  array (
    'dataProduct' => 0,
    'pageLink' => 0,
...
<?php if ($_valid && !is_callable('content_59797ce60da031_83135865')) {function content_59797ce60da031_83135865($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ("header.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
					...
					<script>
						$(document).ready(function() {
							...
							$("#send").on("click", function(){
								...
								var productGambar = $("#productGambar").val();
						...
						$("#productBarcode").autocomplete("test_autocomplete.php", {
								width: 310
							}).result(function(event, item) {
...
">Otomatis</option>
										...
										<tr>
											<td style="padding-top: 15px;">Nama Produk</td>
											<td>:</td>
											<td><input type="text" id="productBarcode" name="productBarcode" style="display: block; width: 270px; height: 20px; padding: 6px 12px; font-size: 14px; line-height: 1.428571429; color: #555; background-color: #fff; border: 1px solid #ccc; border-radius: 4px;" required autofocus></td>
											<td width="20"></td>
											<td>Diskon (%)</td>
											<td>:</td>
...
"><?php echo $_smarty_tpl->tpl_vars['dataBrand']->value[$_smarty_tpl->getVariable('smarty')->value['section']['dataBrand']['index']]['brandName'];?>
											...
											<td>Gambar</td>
											<td>:</td>
	                                    <td><input type="file" name="productGambar"></td></tr>
									</table>
