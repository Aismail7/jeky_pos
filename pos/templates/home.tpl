		...
		<div class="scroller"><!-- this is for emulating position fixed of the nav -->
			<div class="scroller-inner">
				...
				<p style="padding: 20px;">
					{if $outletLevel == '1'}
						Hi <b>{$outletName}</b>, Selamat datang di aplikasi Point of Sales (POS) Web Base. <br>
						Anda dapat melakukan pengolahan data outlet melalui menu yang dapat Anda klik pada pojok kiri atas (Open Menu).
					{else}
						Hi <b>{if $userFullName != ''} {$userFullName} {else} {$outletName} {/if}</b>, Selamat datang di aplikasi Point of Sales (POS) Web Base. <br>
