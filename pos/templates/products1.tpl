...
function autoComplete(){
	...
	if(input==""){
		document.getElementById("hasil").innerHTML="";
			...
			ajaxRequest.open("GET","products.php?input="+input);
			
			ajaxRequest.onreadystatechange=
			function(){
				
				document.getElementById("hasil").innerHTML=ajaxRequest.responeText;
			}
...
function autoInsert(idprd,namaid,namasub){
	
	document.getElementById("inputan").value=namaid.split(" - ").namasub;
	document.getElementById("hasil").innerHTML="";
				...
				<div style="width: 98%; margin: 0px auto;">
					...
					<div id="inline">	
						<table width="100%" align="center">
							...
							<tr>
								<td>
									<form id="product" name="product" method="POST" action="#" enctype="multipart/form-data">
									<table cellpadding="7" cellspacing="7">
							<tr>
							<td style="padding-top: 15px;">Kode Produk <br>
										<td width="5">:</td>
										<td><input type="text" name='namaid' onkeyup='autoComplete();' 
			id='inputan' placeholder="cari produk" style="display: block; width: 244px; height: 20px; padding: 6px 12px; font-size: 14px; line-height: 1.428571429; color: #555; background-color: #fff; border: 1px solid #ccc; border-radius: 4px;" required autofocus><div id='hasil'></div></td>
											
										</tr>
							<tr>
							<td width="120">Kode Barcode</td>
										<td width="5">:</td>
										...
										<option value="">- Auto Kode Barcode -</option>
							...
							<tr>
								<td>Kategori</td>
									...
									<td>Logo</td>
									<td>:</td>
									<td><input type="file" name="gbjalan" id="gbjalan"> </td>
