...
--
-- Host: localhost
-- Generation Time: Aug 20, 2017 at 04:55 PM
...
(31, '5598751313889', 2, '2017-07-31 00:59:28', 1, '0000-00-00 00:00:00', 0),
(32, '5598751313889', 2, '2017-07-31 00:59:28', 1, '0000-00-00 00:00:00', 0);
...
(6, 'ZWBU170727091641', '3212758009345', 4500, 1, 4500, '2017-07-27 21:20:02', 1, '0000-00-00 00:00:00', 0);
...
(2, 'ZWBU170727091641', 'test', '0001', 'OT Group', 'Jakarta Pusat', '(021) 73263267', '2017-07-27', 4500, 0, 4500, 1000, '2', '2017-07-31', '2017-07-27 21:20:47', 1, '0000-00-00 00:00:00', 0);
...
(5, 'ZWBU170727091641', '1', '2017-07-27 21:20:47', 1, '0000-00-00 00:00:00', 0);
...
(1, 'Jeky Jumansyah Point Of Sales', 'Jl.Balaraja, Kab.Tangerang - Banten', '(021) 123456789', 'jejupos@gmail.com', 'pj_170816040359_pj_170803085608_pj_170726093303_coollogo_com-738319.jpg', 'Jeky Jumansyah', '(0231) 358630', '10', 1, 1, 1, 1, 1, 1, '434893748987794', '93485948594859489', '2017-07-27', '2017-08-16 21:04:06', 1);
...
--
-- Table structure for table `as_prdid`
--

CREATE TABLE IF NOT EXISTS `as_prdid` (
...
--
-- Dumping data for table `as_prdid`
--

INSERT INTO `as_prdid` (`idprd`, `namaid`, `namasub`, `insert_by`, `insert_date`, `status`) VALUES
(1, 'TEH CELUP', 'SOSRO ', '', '0000-00-00', 'Y'),
(2, 'KUE', 'TANGGO', '', '0000-00-00', 'Y'),
(3, 'WAFER', 'NISSIN', '1', '2017-07-31', 'Y'),
(8, 'TEH CELUP', 'SARIWANGI', '1', '2017-07-31', 'Y'),
(9, 'ADEM', 'GARY', '1', '2017-07-31', 'Y'),
(10, 'JALABRIA', 'CHOCOLATOS', '1', '2017-07-31', 'Y');

-- --------------------------------------------------------

--
-- Table structure for table `as_prdsub`
--

CREATE TABLE IF NOT EXISTS `as_prdsub` (
...
INSERT INTO `as_products` (`productID`, `supplierID`, `categoryID`, `brandID`, `productBarcode`, `productName`, `productImei`, `productBuyPrice`, `productSalePrice`, `productDiscount`, `productStock`, `productNote`, `createdDate`, `createdUserID`, `modifiedDate`, `modifiedUserID`, `gambar`) VALUES
(1, 1, 11, 9, '3212758009345', 'SOSRO 280ML JASMINE TEA', '437443789213', 4500, 5500, 0, 39, '-', '2014-09-27 14:04:34', 1, '2014-10-25 10:40:35', 1, ''),
...
(7, 1, 11, 13, '5365664891728', 'SOSRO TEH CELUP', '', 1800, 2200, 0, 1, '-', '2014-10-25 10:45:01', 1, '2014-10-25 10:49:10', 1, ''),
(8, 1, 11, 9, '5598751313889', 'SOSRO TEH KANTUNG', '', 1780, 2150, 0, 50, '-', '2014-10-25 10:47:17', 1, '0000-00-00 00:00:00', 0, ''),
(16, 1, 8, 10, '170816100855', 'IRFANULHAKIM', '', 1000, 1500, 1, 2, 'AHMAD', '2017-08-16 22:09:35', 1, '0000-00-00 00:00:00', 0, 'ismail.jpg');
...
INSERT INTO `as_receivables` (`receivableID`, `invoiceID`, `status`, `createdDate`, `createdUserID`, `modifiedDate`, `modifiedUserID`) VALUES
(1, 'OSNM170727091675', '1', '2017-07-27 21:23:25', 1, '0000-00-00 00:00:00', 0);
...
(19, 'BPMT170727013550', '3212758009345', 0, 0, 5500, 4, '', 0, 0, 22000, '2017-07-27 02:37:52', 1, '2017-07-27 02:38:15', 1),
(20, 'HMRY170727023919', '5365664891728', 0, 0, 2200, 49, '', 0, 0, 107800, '2017-07-27 02:41:44', 1, '2017-07-27 02:42:03', 1),
(21, 'APRH170727123544', '1SOSRO', 1000, 1000, 1200, 1, '', 0, 0, 1200, '2017-07-27 12:52:09', 1, '0000-00-00 00:00:00', 0),
(22, 'OSNM170727091675', '3212758009345', 4500, 4500, 5500, 1, '', 0, 0, 5500, '2017-07-27 21:22:54', 1, '0000-00-00 00:00:00', 0),
(23, 'ZVMP170727092390', '3212758009345', 0, 0, 5500, 15, '', 0, 0, 82500, '2017-07-27 23:05:04', 1, '2017-07-27 23:07:11', 1),
(24, 'KWRP170805081515', '3212758009345', 0, 0, 5500, 10, '', 0, 0, 55000, '2017-08-05 08:27:43', 1, '2017-08-05 08:27:57', 1),
(25, 'MBMV170819091386', '2140912123601', 11990, 11990, 12990, 1, '', 0, 0, 12990, '2017-08-19 21:34:44', 1, '0000-00-00 00:00:00', 0);
...
(4, '00002', 'BPMT170727013550', 'Vans Motor', 'Jl. Ki Hajar Dewantara No. 130 Arjawinangun Cirebon', '(0231) 359000', '2017-07-27', 0, 22000, 0, 2200, 24200, 24200, 0, '1', '0000-00-00', '2017-07-27 02:38:52', 1, '0000-00-00 00:00:00', 0),
(5, '00001', 'HMRY170727023919', 'CV. ASFA Solution', 'Jl. Pegadaian No. 38 RT. 01 RW. 01 Arjawinangun - Cirebon', '(0231) 358630', '2017-07-27', 0, 107800, 0, 10780, 118580, 118580, 0, '1', '0000-00-00', '2017-07-27 02:42:17', 1, '0000-00-00 00:00:00', 0),
(6, '00001', 'APRH170727123544', 'CV. ASFA Solution', 'Jl. Pegadaian No. 38 RT. 01 RW. 01 Arjawinangun - Cirebon', '(0231) 358630', '2017-07-27', 2000, 2400, 0, 240, 2640, 2640, 0, '1', '0000-00-00', '2017-07-27 12:52:48', 1, '0000-00-00 00:00:00', 0),
(7, '00001', 'OSNM170727091675', 'CV. ASFA Solution', 'Jl. Pegadaian No. 38 RT. 01 RW. 01 Arjawinangun - Cirebon', '(0231) 358630', '2017-07-27', 4500, 5500, 0, 550, 6050, 1000, 0, '3', '2017-07-31', '2017-07-27 21:23:25', 1, '0000-00-00 00:00:00', 0);
...
(3, '1SOSRO', '2017-07-27', 98, 2, '2', 96, 'ilang', '2017-07-27 13:07:00', 1, '0000-00-00 00:00:00', 0);
...
(1, '0001', 'Jeky Jumansyah', '081211222333', 1, 'N', 'jeky', 'e10adc3949ba59abbe56e057f20f883e', '2014-09-23 12:20:29', 0, '2017-07-27 00:58:37', 1),
(2, '0002', 'ismail', '081293370000', 2, 'N', 'ismail', 'e10adc3949ba59abbe56e057f20f883e', '2014-10-31 15:47:59', 1, '2017-07-27 00:59:16', 1);
